...
import com.wolfd.citygen.city.road.RoadQueue;
import com.wolfd.citygen.city.road.RoadType;
import com.wolfd.citygen.city.road.rules.global.Basic;
import com.wolfd.citygen.city.road.rules.global.Direction;
import com.wolfd.citygen.city.road.rules.global.Grid;
import com.wolfd.citygen.city.road.rules.global.OffRamp;
...
>>>>>>> Stashed changes:citygen/src/main/java/com/wolfd/citygen/city/Roadmap.java
	...
	public Roadmap(City city){
		...
		minimumIntersectionAngle = config.getDouble("minimumIntersectionAngle", 25d); //25
